...
let getEvents = async () => {
  ...
  myContract.events
    .Transfer({
      fromBlock: 14630687, // await web3.eth.getBlockNumber(), // Gets the latest block everytime when the app is started. Will start listening to events that occur after this Block.
    })
